...
const objects = {     // перечень объектов название в программе -> строка в журнале событий
  Na_1: 'Насос 1',
  Na_2: 'Насос 2',
  Zdv_1: 'Задвижка 1',
  Zdv_2: 'Задвижка 2',
...
if (msg.payload == 'change') {  // произошла смена вкладки
  if (msg.name == 'Log') {  // произошло переключение на вкладку с журналом  ------- имя вкладки должно быть актуальным
